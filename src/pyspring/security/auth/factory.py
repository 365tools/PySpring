...
from pyspring.security.auth.providers.base import AuthProvider
...
class AuthProviderFactory:
    ...
    @classmethod
    def register_provider_type(cls, provider_type: str, provider_class: Type[AuthProvider]):
        """
        注册自定义认证提供者类型
...
class AuthProviderFactoryHelper:
    ...
    @staticmethod
    def register_custom_provider(provider_type: str, provider_class: Type[AuthProvider]):
        """
        注册自定义认证提供者
