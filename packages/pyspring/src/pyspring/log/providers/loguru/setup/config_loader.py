...
class ConfigLoader:
    ...
    @classmethod
    def get_console_config(cls, config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        获取控制台配置
    ...
    @classmethod
    def get_file_config(cls, config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        获取文件配置
    ...
    @classmethod
    def get_context_config(cls, config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        获取上下文配置
    ...
    @classmethod
    def get_intercept_config(cls, config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        获取拦截配置
    ...
    @classmethod
    def get_level(cls, config: Optional[Dict[str, Any]] = None) -> str:
        """
        获取日志级别
    ...
    @classmethod
    def get_advanced_config(cls, config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
