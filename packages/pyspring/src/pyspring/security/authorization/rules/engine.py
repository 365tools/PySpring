...
class TimeBasedRule(IRule):
    ...
    def __init__(self, allowed_hours: Optional[List[tuple]] = None, allowed_days: Optional[List[int]] = None):
        """
        Args:
...
class RuleEngine:
    ...
    async def evaluate(self, user_id: Any, resource: str, action: str, context: Dict[str, Any] = None) -> bool:
        """
        评估权限
