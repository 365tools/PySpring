...
from pyspring_cli.core.commands.base import BaseCommand, CommandArg
from pyspring_cli.core.ui.console import print_title, print_success, print_error, print_section, Colors
from pyspring_cli.core.utils.logging import suppress_logs
...
def check_cli_structure(package_path: str = 'pyspring_cli.commands'):
    """
