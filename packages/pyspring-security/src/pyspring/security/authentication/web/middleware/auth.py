...
class AuthenticationMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable[..., Any]) -> Response:
        ...
        try:
            ...
            auth_result = await self._auth_chain.authenticate(request) if self._auth_chain else RequestAuthenticationResult(success=False, error_message="Auth chain not initialized")
