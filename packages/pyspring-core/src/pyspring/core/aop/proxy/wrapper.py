...
class AopProxy:
    ...
    def __init__(self, target: Any, advices: list[_Advice]):
        self._target = target
        self._advices = advices  # List of {'type': 'before', 'func': func, 'pointcut': pattern}
    ...
    def _create_wrapper(self, method_name: str, original_method: Callable[..., object]):
