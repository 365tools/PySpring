...
| `framework.yaml` | `src/pyspring/config/framework.yaml`         | ✅ 更新 | 框架核心配置、自动扫描包     |
...
| 配置说明   | `src/pyspring/config/README.md`        | ✅ 创建 | 配置结构、使用指南、迁移指南 |
| 更新日志   | `CHANGELOG.md`                         | ✅ 更新 | v1.1.0b21 重构说明 |
...
⚠️  src/pyspring/templates/config/logging.yaml       # 已被 defaults/logging.yaml 替代
⚠️  src/pyspring/templates/config/application.yaml   # 仅示例项目需要
⚠️  src/pyspring/templates/config/container.yaml     # 仅示例项目需要
```
